...
from tradingcz.models.market import Bar, StreamQuote, Trade

if TYPE_CHECKING:
    from tradingcz.clients.base import BaseDataClient, StreamHandle
    ...
    **Streaming data** (returns a :class:`StreamHandle`)::
    ...
    async def stream_trades(
        ...
        *,
        ...
        """Stream live trades (individual ticks).
