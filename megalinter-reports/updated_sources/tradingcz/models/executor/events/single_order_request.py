...
from tradingcz.models.enums.order import OrderClass, OrderSide, OrderStatus, TimeInForce
...
class SingleOrderRequest(BaseModel):
    ...
    qty: float | None = Field(
        default=None,
        description="Quantity of the order, used as an alternative to notional",
    )
    notional: float | None = Field(
        default=None,
        description="Total value of the order, used as an alternative to qty",
    )
