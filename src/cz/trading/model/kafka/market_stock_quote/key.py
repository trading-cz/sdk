...
class MarketStockQuoteKey(pydantic.BaseModel):
    """
    Key for stock quote messages. Symbol for filtering, sequence for traceability. Use random partitioner to avoid hot symbol bottleneck.
    """
